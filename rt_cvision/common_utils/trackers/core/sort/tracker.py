...
from common_utils.trackers.core.base import BaseTracker
from common_utils.trackers.core.sort.kalman_box_tracker import SORTKalmanBoxTracker
from common_utils.trackers.utils.sort_utils import (
    get_alive_trackers,
    get_iou_matrix,
...
class SORTTracker(BaseTracker):
    ...
    def _spawn_new_trackers(
        ...
        Args:
            detections (Detections): The latest set of object detections.
            detection_boxes (np.ndarray): Detected bounding boxes in the
                form [x1, y1, x2, y2].
        """
    ...
    def update(self, detections: Detections) -> Detections:
        ...
        Args:
            detections (Detections): The latest set of object detections from a frame.

        Returns:
            Detections: A copy of the input detections, augmented with assigned
