...
topic_config = {
    ...
    'delete.retention.ms': int(config_manager.segmentation.kafka_retention_ms),  # Retain deleted messages for 10 seconds
    'file.delete.delay.ms': 2000,  # Delay file deletion by 2 seconds
}

topic_name = config_manager.segmentation.kafka_publish_topic
